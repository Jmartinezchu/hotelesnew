...
<body onload="imprimir()">
  <div style="text-align:center">
    ...
    <p class="title"><b><?= $request_conf['serie_factura']; ?> - <?php echo str_pad($venta['idventa'], 8, "0", STR_PAD_LEFT); ?></b></p>
    <hr>
    <table align="center">
        <tr>
   ...
   <div class="text-center">
		<p>Usted ha sido atendido por <?= $venta['usuario']?> <br> ¡ELITE Experiencias Sin Limites! </p>
        <p>Representacion impresa de la FACTURA DE VENTA ELECTRONICA</p>
        <p>Para ver el documento visita usqay.pse.pe</p>
    ...
    <?php
       $code_qr = "".$request_conf['ruc']." | 03** | ".$request_conf['serie_factura']." |".str_pad($venta['idventa'], 8, "0", STR_PAD_LEFT)." | ".$venta['total_impuestos']." | ".$subtotal." | ".date("d/m/Y")." | 1* | ".$venta['clienteid']." | ";
