...
<body onload="imprimir()">
   ...
   <div class="text-center">
		<p>Usted esta siendo atendido por <?= $_SESSION['userData']['nombres']?> <br> ¡ELITE Experiencias Sin Limites! </p>
        <p>Representacion impresa de una Precuenta <br> el cual puede canjear por un
        comprobante electronico</p>
        <p>Usqay, es Facturacion Electronica <br> visitanos en www.home.sistemausqay.com <br> o www.facebook.com/UsqayEcuador</p>
	</div>
