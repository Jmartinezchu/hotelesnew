...
<body onload="imprimir()">
   ...
   <p class="title">BOLETA DE VENTA ELECTRONICA</p>
    <p class="title"><b><?= $request_conf['serie_boleta']; ?> - <?php echo str_pad($requestVenta['id_reservacion'], 8, "0", STR_PAD_LEFT); ?></b></p>
  
   <hr>
   <table align="center">
      <tr>
          <td>Fecha de emision</td>
          <td>: <?php echo $requestVenta['fecha'] ?></td>
      </tr>
      <tr>
          <td>Moneda</td>
          <td>: Soles</td>
   ...
   <hr>
    ...
    <div class="text-center">
		<p>Usted ha sido atendido por  <?= $_SESSION['userData']['nombres']?> <br> ¡Gracias por su Preferencia! </p>
