...
<div class="content-page">
    ...
    <div class="container-fluid">
        ...
        <!-- end page title -->
    <form id="formMedioPago" name="formMedioPago">
    <input type="hidden" id="idmediopago" name="idmediopago" value="">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                                <div class="row">
                                <h4 class="page-title">Crear Medio de Pago</h4>
                                    <div class="col-lg 6">
                                        <div class="mb-3">
                                            <label for="example-placeholder" class="form-label">Nombre:</label>
                                            <input type="text" id="nombre" class="form-control" placeholder="Nombre Medio de Pago" name="nombre">
                                        </div>
                                    </div>
                                </div>

                                <div class="modal-footer">
                                    <button id="btnActionForm" type="button" class="btn btn-primary" onclick="guardarMedioPago()"><span id="btnText">Guardar</span></button>&nbsp;
                    ...
                    <div class="card-header">
                        <div class="tab-content">         
                            <div class="table-responsive">
                                <table id="tableMedioPago" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                        <th>ID</th>
                                        <th>Nombre</th>
