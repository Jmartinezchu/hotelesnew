...
$fechaFin = date('Y-m-d');
$sql = "SELECT b.id as id_boleta, b.serie, r.usuarioid as usuario, r.reservacionid, r.created_at, r.total as total_venta, (r.total/110)*10 as total_impuestos, (r.total/110)*100 as subtotal from boleta b  left join reservaciones_payments r on r.reservacionid = b.id_venta WHERE r.created_at BETWEEN '" . $inicio . " 00:00:00' AND '" . $fin . " 23:59:59'";
...
<div class="wrapper">
    <div class="content-page">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Boletas de reservas</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
        ...
        <script>
            function buscar() {
                window.location.href = base_url + "/reports/boletares?fecha_inicio=" + $('#fechainicio').val() +
