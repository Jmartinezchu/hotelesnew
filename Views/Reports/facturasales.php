...
$fechaFin = date('Y-m-d');
$sql = "SELECT f.id as id_factura, f.serie, v.idventa, v.usuario, v.subtotal, v.total_impuestos, v.venta_estado_id as estado, v.total_venta, v.created_at  FROM venta v INNER JOIN factura f ON v.idventa = f.id_venta  WHERE v.created_at BETWEEN '" . $inicio . " 00:00:00' AND '" . $fin . " 23:59:59'";
...
<div class="wrapper">
    <div class="content-page">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Facturas de ventas</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
        ...
        <script>
            function buscar() {
                window.location.href = base_url + "/reports/facturasales?fecha_inicio=" + $('#fechainicio').val() +
